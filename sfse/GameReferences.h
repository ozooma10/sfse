...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02116840)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x00B58D50)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x0047FCE0, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x0195D540, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x017A8B60);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x017A93D0, u32 skinToneIndex);
